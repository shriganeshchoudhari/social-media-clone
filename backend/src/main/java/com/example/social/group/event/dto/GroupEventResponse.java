...
public class GroupEventResponse {
    ...
    public GroupEventResponse(Long id, String title, String description, LocalDateTime startTime, LocalDateTime endTime,
            String location, String organizerUsername, Long organizerId, LocalDateTime createdAt) {
        this.id = id;
        this.title = title;
    ...
    public static class Builder {
        ...
        public GroupEventResponse build() {
            return new GroupEventResponse(id, title, description, startTime, endTime, location, organizerUsername,

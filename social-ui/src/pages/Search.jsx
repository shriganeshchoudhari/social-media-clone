                                ...
                                {u.username !== currentUser && (
                                    <div className="flex gap-2 mt-2 sm:mt-0">
                                        <button
                                            ...
                                            className="px-4 py-2 bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 rounded-full text-sm font-medium transition-colors shrink-0 flex items-center gap-1"
                                        >
                                            <span>👤</span> <span className="hidden sm:inline">Profile</span>
                                        </button>
                                        <button
                                            onClick={() => navigate(`/chat/${u.username}`)}
                                            className="px-4 py-2 bg-blue-50 text-blue-600 hover:bg-blue-100 dark:bg-gray-700 dark:text-blue-400 dark:hover:bg-gray-600 rounded-full text-sm font-medium transition-colors shrink-0 flex items-center gap-1"
                                        >
